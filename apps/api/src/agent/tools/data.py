...
class StoreBackedTools:
    ...
    def _get_company_profile(
        ...
        profile: dict[str, Any] = {
            ...
            "industry": {
                "code": roster.industry_code if roster is not None else None,
                "name": roster.industry_name if roster is not None else None,
                "as_of": listing_as_of,
                "available": bool(roster is not None and roster.industry_code),
            },
            "shares": [],
            "foreign_room": None,
        ...
        elif roster.industry_code is None:
