...
def test_the_hash_is_exported_and_changes_when_the_prose_changes():
    ...
    # protocol the Recommendation Validator reads (#82), 1.2.0 added the
    # Widget selection protocol the Widget validator reads (#89), and 1.3.0
    # injected today's date and said how it is read against the Trading Day.
