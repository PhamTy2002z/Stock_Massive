...
### Action Items
- [ ] Phase 1: Grid layout 2 cột cho Bar + Pie chart
- [ ] Phase 2: Single-select sector filter (không multi-select)
- [ ] Phase 3: Implement Tabs component cho 4 chart types
- [ ] Phase 3: Treemap ẩn trên mobile, hiện trên desktop
