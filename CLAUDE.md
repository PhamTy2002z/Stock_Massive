...
**IMPORTANT** ShadCN + TaiwindCSS always Priority 1 before consider using any different framework for implement
**IMPORTANT** Always "Reusable UI Components" as an default standardize for UI/UX.

# Backend Standardize
**IMPORTANT** Follows Feature-based Modular Architecture with Separation of Concerns.
